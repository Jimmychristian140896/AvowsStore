...
import com.jimmy.avowsstore.ui.theme.LightGreyTextFieldBackground
import com.jimmy.avowsstore.ui.theme.TextFieldCheckColor
import com.jimmy.avowsstore.ui.theme.TextFieldHintColor
    ...
    Row(
        ...
        if(isValid) {
            Icon(
                ...
                contentDescription = stringResource(R.string.is_valid_icon),
